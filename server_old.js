...
function generateVisitorEmailHTML(visitorData, qrCodeBase64, hasPhoto, photoBase64) {
...
<div class="wrap">
  ...
  <div class="body">
    ...
    <div class="qr-sec">
      ...
      <img src="data:image/png;base64,${qrCodeBase64}" class="qr-img" alt="QR Code">
    ...
    <div class="photo-sec">
      <h3>📸 Visitor Photo</h3>
      <img src="data:image/jpeg;base64,${photoBase64}" class="photo-img" alt="Visitor Photo">
    </div>` : ''}
...
app.post('/api/visitors', async (req, res) => {
  try {
    ...
    // ── Send email via Resend (HTTP — works on Render free tier) ──────────
    let emailSent = false;
    let emailError = null;
